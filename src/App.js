  ...
  render() {
    return (
        <div className="fl w-100 mb2">
          ...
          <Paragraph no="¶">My primary focus is mobile apps. I'm the happiest when I'm solving complex problems through elegant systems and user-friendly interfaces. </Paragraph>
