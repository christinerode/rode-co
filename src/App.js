  ...
  render() {
    return (
        <div className="fl w-100 mb2">
          ...
          <Paragraph no="¶">With a focus on mobile apps, I'm happest when I'm solving complex problems through elegant products and user-friendly interfaces. </Paragraph>
