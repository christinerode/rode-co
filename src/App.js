  ...
  render() {
    return (
        <div className="fl w-100 mb2">
          ...
          <Paragraph no="¶">I primarily design mobile apps. I'm happiest when I'm solving complex problems through elegant systems and user-friendly interfaces. </Paragraph>
